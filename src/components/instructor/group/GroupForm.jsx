...
import { createGroup, updateGroup, fetchGroupById } from '../../../service/groupService';
import { Form, FormGroup, Label, Input, Button } from 'reactstrap';
import { useNavigate, useParams } from 'react-router-dom';
import toast from 'react-hot-toast';
import { courseListService, fetchAllUsersService } from '../../../service/baseService';
...
const GroupForm = () => {
    ...
    const fetchGroup = async () => {
        try {
            ...
            toast.error(error.response?.data?.details || "Failed to fetch group data. Please try again.");
        }
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            toast.error(error.response?.data?.details || "An error occurred. Please try again.");
        }
    };
    ...
    return (
        <Form onSubmit={handleSubmit} className="mb-4">
            ...
            <FormGroup>
                ...
                <small>Select multiple users by holding down the Ctrl (Windows) or Command (Mac) button.</small>
            </FormGroup>
            <FormGroup>
                ...
                <small>Select multiple courses by holding down the Ctrl (Windows) or Command (Mac) button.</small>
            </FormGroup>
